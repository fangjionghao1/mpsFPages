...
<el-collapse v-model="activeNames">
    ...
    <div>
        <el-row :gutter="20">
            ...
            <el-col :span="6">{{ this.data.config.DbPort }}<div class="grid-content bg-purple"></div></el-col>
        </el-row>
        <el-row :gutter="20">
        ...
        <!-- <el-row :gutter="20">
            ...
            <el-col :span="6">{{this.data.config.Server.DBName}}<div class="grid-content bg-purple"></div></el-col>
        </el-row> -->
    </div>
    </el-collapse-item>
    <el-collapse-item title="代理服务器信息" name="3">
        ...
        <el-col :span="6">端口(Port)：<div class="grid-content bg-purple"></div></el-col>
        <el-col :span="6">{{ this.data.config.ProxyPort }}<div class="grid-content bg-purple"></div></el-col>
        </el-row>
        </div>
    </el-collapse-item>
    <el-collapse-item title="服务器信息" name="4">
        ...
        <el-row :gutter="20">
        <el-col :span="6">ip:<div class="grid-content bg-purple"></div></el-col>
        <el-col :span="6">{{this.data.config.Server.}}<div class="grid-content bg-purple"></div></el-col>
        <el-col :span="6">端口(Port)：<div class="grid-content bg-purple"></div></el-col>
        <el-col :span="6">{{ this.data.config.ProxyPort }}<div class="grid-content bg-purple"></div></el-col>
        </el-row>
        </div>
