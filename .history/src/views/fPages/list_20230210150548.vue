...
<el-collapse v-model="activeNames">
    ...
    <div>
        ...
        <el-row :gutter="20">
        <el-col :span="6">数据库密码：<div class="grid-content bg-purple"></div></el-col>
        <el-col :span="6">{{this.data.config.DbPassWord}}<div class="grid-content bg-purple"></div></el-col>
        <el-col :span="6">数据库账号(Account)：<div class="grid-content bg-purple"></div></el-col>
        <el-col :span="6">{{ this.data.config.Account }}<div class="grid-content bg-purple"></div></el-col>
        </el-row>
    </div>
    </el-collapse-item>
    <el-collapse-item title="数据库配置" name="3">
        <div>
